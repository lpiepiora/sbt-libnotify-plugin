...
#include <jni.h>
/* Header for class it_paperdragon_libnotify_LibNotify__ */

#ifndef _Included_it_paperdragon_libnotify_LibNotify__
#define _Included_it_paperdragon_libnotify_LibNotify__
#ifdef __cplusplus
extern "C" {
#endif
/*
